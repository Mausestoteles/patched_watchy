...
// ----------------------------------------------------------------------------
// This BLE OTA path accepts firmware writes from ANY BLE peer in range with
// no pairing, no bonding, and no signature verification on the received image.
// The "last packet" boundary is inferred from packet length (see otaCallback),
